        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.php">
                        <h2 style="color: #fff">RTU VPMS!! Create Your account</h2>
                    </a>
                </div>
                ...
                <div class="login-form">
                    <form method="post" onsubmit="return checkpass();">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="mobilenumber" maxlength="11" pattern="[0-9]{11}" placeholder="Mobile Number" required="true" class="form-control">
                        </div>
                        <div class="form-group">
